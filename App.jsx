...
// This reads from your .env file so keys aren't exposed on GitHub
...
export default function DailyRoutineProFinalXP() {
  ...
  useEffect(() => {
    // If auth is null (meaning config was missing), stop loading
    if (!auth) {
      setLoading(false);
      return; 
    }
  ...
  if (!app) return (
    <div className="min-h-screen flex items-center justify-center p-4 text-center flex-col gap-4">
      ...
      <p>Missing Firebase Keys in .env file.</p>
    </div>
  );
